...
import { useListExchangesQuery, useListTickersQuery } from "data-access";
      ...
      <Select>
        ...
        <SelectContent>
          <SelectGroup>
            ...
            <SelectItem :value="exchange.id" v-for="exchange in exchanges?.results"> {{ exchange.name }} </SelectItem>
          </SelectGroup>
        </SelectContent>
      </Select>
      <Combobox
